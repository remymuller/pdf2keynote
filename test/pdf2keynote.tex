...
\begin{frame}
	...
	\href{vibra.wav}{\beamergotobutton{Vibra Sound}}
	%\movie[autostart]{An movie/audio file}{vibra.wav}
	%\sound[autostart,encoding=Signed]{An audio file}{vibra.wav}
%	\href{run:vibra.wav}{Run:Vibra}
	%\hyperlinksound{An audio file}{file:///Users/muller/projects/PhD/Python/pdf2keynote/test/vibra.wav}
\end{frame}

\begin{frame}
	\frametitle{Video Slide}
	\href{Balisurf.m4v}{\beamergotobutton{Bali Surf}}
	%\movie[autostart]{An movie/audio file}{vibra.wav}
\end{frame}
